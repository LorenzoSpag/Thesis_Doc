...
Apart from logistic and multinomial regression there are various other supervised classifiying methods such as Support Vector Machines (SVM) \cite{SVM}, Neural Networks\cite{ANN} and Decision Trees\cite{DecisionTrees}. In this thesis, among the aforementioned algorithms, the chosen one was a particular evolution of DecisionTrees called RandomForest (RF)\cite{RandomForest}.
