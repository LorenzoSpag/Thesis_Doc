...
\todo[inline]{queste tabelle ovviamente non vanno qui}
...
Since the start of 2020 \textit{Sars-COVID19} has given rise to a world-wide pandemic.\todo[inline]{ti consiglio di mettere la parola covid come macro per scriverla sempre in modo consistente}
...
This can be taken as a symptom that the more complex \textit{Sars-COVID19} cases are still too difficult to be segmented automatically, or semi-automatically by untrained personnel, which will lead to counter-intuitive results further down the analysis pipeline.
