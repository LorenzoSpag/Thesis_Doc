...
\begin{figure}[H]
\centering
  	\subfloat[][Example of segmentation classified as bad]{\includegraphics[width=\linewidth]{Bad_segm_anon.jpg}\label{fig:badseg}}
	\newline
...
%This qualitative analysis seems to show somewhat of a bias of worse prognosis towards worse segmentations. 
